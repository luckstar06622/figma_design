    ...
    <Stack color='white' alignItems="center">
      ...
      <Box sx={{ pb: 4 }}>
        <Stack alignItems="center">
          ...
          <Typography variant="body1" color="#bdbdbd" sx={{ mb: '22px', px: '20px' }}>
          ...
          <Box sx={{px:'20px'}}>
            <Stack sx={{ padding: "30px", borderRadius: "28px", backgroundImage: {md:`url(${cardbg})`,sm:`url(${cardbg})`,xs:`url(${cardbgmobile})`}, backgroundSize: "cover", backgroundPosition: "center", backgroundRepeat: "no-repeat", width: "100%", height: "100%" }}>
