...
import card1 from '../assets/btrace/card1.svg';
import card2 from '../assets/btrace/card2.svg';
import card3 from '../assets/btrace/card3.svg';
    ...
    <Stack color='white' alignItems="center" sx={{ width: '100%' }}>
      ...
      <Box sx={{ pt: 2, pb: 4 }}>
        <Stack alignItems="center">
          <Typography variant="h4" fontWeight="bold" align="center" sx={{ mb: '35px' }}>
            Checking A Crypto Wallet For <br /> Connection With <Box component="span" color="#767676">“Dirty”</Box> Money Will Allow
          </Typography>
      ...
      <Box maxWidth="lg" sx={{ mb: 8 }}>
        ...
        <Grid container spacing={3} alignItems="center">
          <Grid item size={6} md={6}>
            ...
            <Button variant="contained" endIcon={<ArrowForwardIosIcon />} sx={{ borderRadius: 8, px: 4, py: 2, bgcolor: 'white', color: 'white', background: 'linear-gradient(308.69deg, #FF8629 63.74%, #FFD729 92.78%)' }}>FIRST CHECK FREE</Button>
          </Grid>
          <Grid item size={6} md={6}>
      ...
      <Box maxWidth="md" sx={{ mb: 8 }}>
        ...
        <Box sx={{ mt: 4 }}>
          {faqData.map((faq, idx) => (
            <Accordion key={idx} sx={{ backgroundImage: `url(${questionbg})`, backgroundSize: 'unset', backgroundPosition: 'center', backgroundRepeat: 'no-repeat', color: 'white', mb: 2, borderRadius: 2, boxShadow: 2 }}>
